...
//O stateless no creation policy faz a verificação de toda requisição recebida para saber se é de alguém que está autenticado
//Ou se está tentando acessar algo sem segurança